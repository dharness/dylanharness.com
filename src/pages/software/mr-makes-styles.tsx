...
export const mrMakesStyle = css`
  ...
  .mr-grid {
    ...
    grid-template-rows: repeat(3, auto) repeat(9, 5vw);
    -moz-column-gap: 20px;
  ...
  .mr-trailer-frame iframe {
    width: 100%;
    height: 101%;
  }
  .mr-trailer-frame video {
    position: absolute;
    bottom: 0;
  }
  .aspect-ratio-box {
  ...
  .mr-sticker-lg-poof {
    padding-top: 141.38889%;
    border-radius: 7px;
    grid-column: 1/4;
    grid-row: 9/13;
    position: relative;
  }
  .mr-sticker-lg-poof img,
  .mr-sticker-lg-poof picture {
    width: 130%;
  }
  #sticker-poof-anim {
    ...
    background-size: 800%;
    -webkit-animation: anim 1s steps(8) infinite;
  ...
  @media (max-width: 767px) {
    ...
    .mr-trailer.aspect-ratio-box {
      overflow: unset;
      height: unset;
      position: unset;
    }
    .mr-trailer .aspect-ratio-box-inside {
      position: relative;
    }
    .mr-trailer video {
      width: 102%;
